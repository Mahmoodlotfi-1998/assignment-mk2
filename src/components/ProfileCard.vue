    ...
    <div class="card">
      ...
      <div class="data">
        <div class="profile-content">
          ...
          <div class="specialisation">{{profile.specialisation}}</div>
        </div>
        <div class="likes" @click="$emit('likeAction')">
          <span class="likes-icon" v-if="!profile.liked">💚</span>
          <span class="likes-icon" v-else>🧡</span>
